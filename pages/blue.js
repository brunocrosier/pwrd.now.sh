...
const scrollYProgress = useScrollYPosition()
  ...
  return (
    <>
      <CssBaseline />
      <HeadTag topbarcolor={colorScheme.topbarcolor} />
      ...
      <AppContainer colorScheme={colorScheme}>
        <div id="app-container">
          <motion.div
            ...
            className={(scrollYProgress < 10) ? "" : "scrolled-menu-bar"}
          >
...
const AppContainer = styled.div`
  ...
  .scrolled-menu-bar {
    ...
    background: linear-gradient(25deg, #2095df, #63e9f1)!important;
  }
  ...
  #input-component {
    ...
    border-radius: 20px;
    box-shadow: 0px 5px 5px #0da2c557;
  }
